...
import TestContractAbi from '../truffle/build/contracts/TestContract.json'
import SameContractAbi from '../truffle/build/contracts/SameContract.json'
export default class Test extends React.Component {
    ...
    constructor(props) {
        ...
        this.abi = SameContractAbi;
        this.TestContract = this.web3.eth.contract(this.abi);
        console.log(this.TestContract);
        this.web3.eth.defaultAccount = this.web3.eth.accounts[0];
        const test = this.TestContract.at('0x28B105Af63eF8D86166483AfAB8ED206C285CbE3');
        console.log(test);
